...
namespace Birdie.Core.Data.Migrations
{
    ...
    [Migration("20210903030011_ChangesToSomeTables")]
    partial class ChangesToSomeTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.Favorite", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.Hashtag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.Media", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.Mention", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("TweetId")
                        .HasDatabaseName("ix_mentions_tweet_id");

                    b.ToTable("mentions");
                });

            modelBuilder.Entity("Birdie.Core.Data.Entities.Retweet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.SavedSearch", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.Tweet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("SearchVector")
                        .HasDatabaseName("ix_tweets_search_vector")
                        .HasMethod("GIN");
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.TweetStats", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.Url", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.Media", b =>
                {
                    b.HasOne("Birdie.Core.Data.Entities.Tweet", "Tweet")
                        .WithMany("Mediae")
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.Mention", b =>
                {
                    b.HasOne("Birdie.Core.Data.Entities.Tweet", "Tweet")
                        .WithMany("Mentions")
                        .HasForeignKey("TweetId")
                        .HasConstraintName("fk_mentions_tweets_tweet_id");
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.SavedSearch", b =>
                {
                    b.HasOne("Birdie.Core.Data.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.TweetStats", b =>
                {
                    b.HasOne("Birdie.Core.Data.Entities.Tweet", "Tweet")
                        .WithOne("Stats")
                        .HasForeignKey("Birdie.Core.Data.Entities.TweetStats", "TweetId")
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.User", b =>
                {
                    b.HasOne("Birdie.Core.Data.Entities.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("Birdie.Core.Data.Entities.UserStatistics", b =>
                {
                    b.HasOne("Birdie.Core.Data.Entities.User", "User")
                        .WithOne("Statistics")
                        .HasForeignKey("Birdie.Core.Data.Entities.UserStatistics", "UserId")
            ...
            modelBuilder.Entity("HashtagTweet", b =>
                {
                    b.HasOne("Birdie.Core.Data.Entities.Hashtag", null)
                        .WithMany()
                        .HasForeignKey("HashtagsId")
                        .HasConstraintName("fk_hashtag_tweet_hashtags_hashtags_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Birdie.Core.Data.Entities.Tweet", null)
                        .WithMany()
